...
const testimonials: Testimonial[] = [
  ...
  {
    id: 4,
    name: 'Sven Olav Løstegaard',
    role: 'Hytteutleier',
    location: 'Østlandet',
    text: 'Hun lyttet, kommuniserte godt og håndterte prosjektet med ro og kreativitet. Resultatet ble bedre enn forventet.',
  },
]
